...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            ...
            InlineKeyboardButton('ℹ 𝙷𝙴𝙻𝙿 ℹ', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/mrallmovieschannel")
            ],[      
            InlineKeyboardButton("ℹ 𝙷𝙴𝙻𝙿 ℹ", callback_data="help"),
